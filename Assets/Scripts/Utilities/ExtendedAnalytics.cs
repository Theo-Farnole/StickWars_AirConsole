...
#if UNITY_EDITOR
        Debug.LogFormat("<color=red>Analytics</color> # Event <color=green>{0}</color> fired with result {1}. (param: {2})", eventName, result, eventData != null ? eventData.ToDebugString() : "NONE");
#endif
    }
}